...
pub fn lake_context_derive(input: TokenStream) -> TokenStream {
    ...
    let expanded = quote! {
        // The generated impl.
        impl near_lake_framework::LakeContextExt<near_lake_framework::near_lake_primitives::block::Block> for #name {
            fn execute_before_run(&self, block: &mut near_lake_framework::near_lake_primitives::block::Block) {
                #( #calls_before_run )*
            }
